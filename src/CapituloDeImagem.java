...
public class CapituloDeImagem extends Capitulo {
    ...
    public CapituloDeImagem(Capitulo capitulo, String imagem) {
         this.imagem = imagem;
         this.personagem = capitulo.personagem;
         this.texto = capitulo.texto;
         this.variacaoEnergiaPersonagem = capitulo.variacaoEnergiaPersonagem;
